...
public class TestController {
	...
	public List<Object> insertTestData() {
		...
		toReturn.add(this.creatAndSaveDataIngredient());
		toReturn.add(this.creatAndSaveDataRecette());
	...
	public Set<IngredientRecette> generatorIngredients(int idRecette, int number){
		String[] descriptions = {"tones","g", "cubes","demi molles","bouquet","l","pincés"};
		...
		for(int i = 0; i < number; i++) {
			...
			String descriptionIngredient = (random.nextInt(1000)+2) + " "+ descriptions[random.nextInt(descriptions.length)];
			...
			ingredientRecette.setValeur(descriptionIngredient);
	...
	public List<Ingredient> creatAndSaveDataIngredient(){
		...
		List<Ingredient> ingredients = Arrays.asList(
				...
				new Ingredient(0, "oigon jaune",
						...
						null),
				new Ingredient(0, "moutarde",
						CathIngre.SAUCE, null,
				...
				new Ingredient(0, "vin blanc",
						...
						,null),
				new Ingredient(0, "champignon de Paris",
						CathIngre.CHAMPIGNON, null,
						...
						,null),
				new Ingredient(0, "farine",
						CathIngre.FARINE, null,
						...
						,null),
				new Ingredient(0, "persil",
						CathIngre.HERBE, null,
	...
	public List<Recette> saveRecettePersonalise(){
		...
		ingrediantsoupeAuLardon.setValeur("500g de lardon");
		...
		List<IngredientRecette> ingrediantsChatALaMoutarde = Arrays.asList(
				new IngredientRecette(0, "1 chat découpé", chatALaMoutarde, new Ingredient(22)),
				new IngredientRecette(0, "1 oignon", chatALaMoutarde, new Ingredient(13)),
				new IngredientRecette(0, "8 cuillères à soupe de moutarde", chatALaMoutarde, new Ingredient(17)),
				new IngredientRecette(0, "1 échalote", chatALaMoutarde, new Ingredient(15)),
				new IngredientRecette(0, "1 gousse d'ail", chatALaMoutarde, new Ingredient(16)),
				new IngredientRecette(0, "1/2 l de vin blanc", chatALaMoutarde, new Ingredient(18)),
				new IngredientRecette(0, "300 g de champignons de Paris", chatALaMoutarde, new Ingredient(22)),
				new IngredientRecette(0, "50 g de farine", chatALaMoutarde, new Ingredient(20)),
				new IngredientRecette(0, "sel", chatALaMoutarde, new Ingredient(9)),
				new IngredientRecette(0, "poivre", chatALaMoutarde, new Ingredient(8))
				);
